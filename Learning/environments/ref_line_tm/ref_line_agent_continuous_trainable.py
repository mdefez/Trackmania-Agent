...
class RefLineEnvContinuous(TMEnv) :
    ...
    def reward(self, data) -> float :
        ...
        if distance_to_line > MAX_DIST_TO_LINE :
            return - abs(self.angle_to_median_line) * 30 * self.speed
        ...
        # dist_to_line_term = 0
        angle_to_line_term = - float(abs(median_line_angle) * 30)
        ...
        return angle_to_line_term  + dist_to_line_term  + d_dist_term + speed_term
